...
public:
	...
	std::vector<Vec2<Vec2i> > getAnims() const; //Returns a vector with the start and end of each animation (in order) for this sheet
...
private:
	...
	int anims;
	int* lengths;
	std::vector< std::vector<Vec2i> > animations; // because a Vec2i** doesn't really work ¬¬
